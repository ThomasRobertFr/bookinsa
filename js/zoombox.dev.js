...
var zoombox_path = 'includes/zoombox/';
...
* */
function windowH(){
        if (window.innerHeight) return (window.innerHeight - options.margeBas);
        else{return ($(window).height() - options.margeBas);}
}
